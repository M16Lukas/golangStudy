...
func main() {
	...
	fmt.Println(time.Now().UnixNano()) // 1677068097558831100
	rand.Seed(time.Now().UnixNano())

	//0~99の間の疑似乱数
	fmt.Println(rand.Intn(100)) // 88

	//int型の疑似乱数
	fmt.Println(rand.Int()) // 7906063471869198859

	//int32型の疑似乱数
	fmt.Println(rand.Int31()) // 159702522

	//int64型の疑似乱数
	fmt.Println(rand.Int63()) // 3050997788483281791

	//uint32型の疑似乱数
	fmt.Println(rand.Uint32()) // 2090952021
